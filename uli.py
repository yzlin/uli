# LLDB script that lets you easily use uli
...
drawRectPath = '/usr/local/bin/uli'
...
def __lldb_init_module(debugger, unused):
    debugger.HandleCommand('command script add --function uli.drawrect dr')
    debugger.HandleCommand('command script add --function uli.drawrectFlipped drf')

    debugger.HandleCommand('command script add --function uli.clear drc')
